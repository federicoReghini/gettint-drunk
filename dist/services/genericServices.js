...
function _postApi() {
  _postApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resource, obj) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", axiosInstance.post(resource, obj).then(responseApi()).catch(responseApiError()));
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", axiosInstance.get(resource).then(responseApi()).catch(responseApiError()));
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", axiosInstance.put(resource, obj).then(responseApi()).catch(responseApiError()));
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", axiosInstance.delete(resource).then(responseApi()).catch(responseApiError()));
